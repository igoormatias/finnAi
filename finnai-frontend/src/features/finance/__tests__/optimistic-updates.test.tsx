...
vi.mock("@/features/finance/hooks/use-categories", () => ({
  useCategories: () => ({
    data: [{ id: "c1", name: "Alimentação", type: "expense", color: "#35e0a1", icon: "tag", is_fixed: false }],
    isError: false,
  }),
  useCreateCategory: () => ({}),
  useUpdateCategory: () => ({}),
...
vi.mock("@/features/finance/hooks/use-accounts", () => ({
  useAccounts: () => ({
    data: [{ id: "a1", name: "Nubank", type: "checking", initial_balance_cents: 0, current_balance_cents: 0 }],
    isError: false,
    isLoading: false,
  }),
  useCreateAccount: () => ({}),
...
vi.mock("@/features/finance/hooks/use-transactions", () => ({
  useTransactions: () => ({
