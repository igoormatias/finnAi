...
import type {
  ...
  Category,
  TransactionType,
  TransactionsFilters as TransactionsFiltersState,
...
export const TransactionsFilters = ({ categories, accounts, filters, onChange, onClear }: FiltersProps) => {
      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            value={filters.sort}
            onChange={(e) =>
              onChange({ ...filters, sort: e.currentTarget.value as TransactionsFiltersState["sort"], offset: 0 })
            }
          >
            ...
            <SheetContent side="bottom" className="space-y-4">
              <SheetHeader>
                <div className="flex items-center justify-between">
                  <div>
                    <SheetTitle className="text-sm font-semibold text-foreground">Filtros</SheetTitle>
                    <SheetDescription className="text-xs text-muted">
                      Ajuste as opções para refinar a listagem.
                    </SheetDescription>
                  </div>
