    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close
          className="absolute right-4 top-4 inline-flex h-9 w-9 items-center justify-center rounded-lg border border-border bg-elevated/40 text-muted hover:bg-elevated hover:text-foreground"
          aria-label="Fechar"
        >
          <X className="h-4 w-4" />
        </DialogPrimitive.Close>
